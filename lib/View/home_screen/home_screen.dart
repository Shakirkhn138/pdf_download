...
//   final String companyName = "XYZ Company Pvt. Ltd.";
//   final String certificateTitle = "Certificate of Completion";
//   final String userName = "John Doe";
//   final String courseDetails = "Successfully completed the Flutter Development Course.";
//   final String currentDate = "${DateTime.now().toLocal()}";
//
...
//             children: [
//               pw.Image(image, width: 100, height: 100), // Company Logo
//               pw.SizedBox(height: 10),
//               pw.Text(companyName, style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
//               pw.Divider(),
//               pw.SizedBox(height: 20),
//               pw.Text(certificateTitle, style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
//               pw.SizedBox(height: 10),
//               pw.Text('This is to certify that $userName has $courseDetails.',
//                   textAlign: pw.TextAlign.center, style: pw.TextStyle(fontSize: 16)),
//               pw.SizedBox(height: 30),
//               pw.Text('Date: $currentDate'),
//               pw.SizedBox(height: 50),
//               pw.Text('Authorized Signature', style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
//             ],
//           ),
//         ),
//       );
...
//     return Scaffold(
//       appBar: AppBar(title: Text("Certificate Details")),
//       body: Padding(
//         padding: const EdgeInsets.all(16.0),
//         child: Column(
//           crossAxisAlignment: CrossAxisAlignment.center,
//           children: [
//             Image.asset('assets/images/images.jpeg', width: 100, height: 100), // Show Logo on screen
//             SizedBox(height: 10),
//             Text(companyName, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
//             Divider(),
//             SizedBox(height: 20),
//             Text(certificateTitle, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
//             SizedBox(height: 10),
//             Text('This is to certify that $userName has $courseDetails.',
//                 textAlign: TextAlign.center, style: TextStyle(fontSize: 16)),
//             SizedBox(height: 30),
//             Text('Date: $currentDate'),
//             SizedBox(height: 50),
//             Text('Authorized Signature', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
//             SizedBox(height: 40),
//             ElevatedButton(
